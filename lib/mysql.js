 ...
 * Module dependencies
 */
console.log("in the loopback connector");
var AWSXRay = require('aws-xray-sdk');

var SqlConnector = require('loopback-connector').SqlConnector;
var ParameterizedSQL = SqlConnector.ParameterizedSQL;
var EnumFactory = require('./enumFactory').EnumFactory;
var mysql = AWSXRay.captureMySQL(require('mysql'); console.log("after initializing the loopback connector");
    ...
    MySQL.prototype.buildExpression = function(columnName, operator, operatorValue,
      ...
      if (operator === 'regexp') {
        ...
        return new ParameterizedSQL(columnName + ' REGEXP ?', [operatorValue.source]);
      }
    ...
    require('./migration')(MySQL, mysql); require('./discovery')(MySQL, mysql); require('./transaction')(MySQL, mysql);
